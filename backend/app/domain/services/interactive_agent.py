...
INTERACTIVE_AGENT_SIGNAL_APPETITE_SCHEMA_VERSION = 4
INTERACTIVE_AGENT_BRIEFING_SCHEMA_VERSION = 5
...
INTERACTIVE_AGENT_SIGNAL_APPETITE_POLICY_VERSION = "interactive-signal-appetite-v4"
INTERACTIVE_AGENT_BRIEFING_POLICY_VERSION = "interactive-briefing-v5"
INTERACTIVE_AGENT_POLICIES = {
    ...
    INTERACTIVE_AGENT_BRIEFING_SCHEMA_VERSION: INTERACTIVE_AGENT_BRIEFING_POLICY_VERSION,
}
