...
func buildHandler(ctx context.Context, cfg config.Config) (http.Handler, func() error, error) {
	...
	sessionDatabaseCandidate := cfg.SessionAdminLoginCandidate || sessionStoreCandidate
	...
	if cfg.SessionLoginCandidate && !sessionDatabaseCandidate {
	...
	modules := httpserver.Modules{
		...
		SessionAdminPasswordChange:      cfg.SessionAdminLoginCandidate,
