...
| Password reset | `PASSWORD_RESET_ENABLED`、`PASSWORD_RESET_*`、`SMTP_HOST/PORT/USERNAME/PASSWORD/FROM_*`、`SMTP_STARTTLS/USE_TLS` | 默认开启且无需 GitHub var；SMTP 未配齐时 fail closed，密码只进 Secret，详见密码重置 Runbook |
